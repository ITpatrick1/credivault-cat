...
getContractFactory(name: 'CrediVault', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.CrediVault__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'CrediVault', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.CrediVault>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'CrediVault', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.CrediVault>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'CrediVault', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.CrediVault>
